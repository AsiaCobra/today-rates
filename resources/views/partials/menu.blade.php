    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @endcan
                @can('gold_price_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.gold-prices.index") }}" class="nav-link {{ request()->is("admin/gold-prices") || request()->is("admin/gold-prices/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-cogs">

                            </i>
                            <p>
                                {{ trans('cruds.goldPrice.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
